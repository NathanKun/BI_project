...
package projet_bi.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String url = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=srvlaboinfo)(port=1521))(connect_data=(service_name=orcl.intranet.int)))";
				java.sql.Connection conn = java.sql.DriverManager
						.getConnection(url, "BI_2", "BI_2");
				...
				java.sql.ResultSet rs = stm
						.executeQuery("SELECT     BI_2.PARTENAIRE_PTN.PTN_NOM AS \"Partenaire Nom\",    (CASE WHEN       SUM(BI_2.FAIT_PARTENAIRE.CRD_DEMANDE)       >       SUM(BI_2.FAIT_PARTENAIRE.CAPITAL_SOCIAL)       THEN 1 ELSE 0 END) AS \"CRD>Capital Social?\",    SUM(BI_2.FAIT_PARTENAIRE.CRD_DEMANDE) AS CRD,     SUM(BI_2.FAIT_PARTENAIRE.CAPITAL_SOCIAL) AS \"Capital Social\"    FROM BI_2.FAIT_PARTENAIRE    INNER JOIN BI_2.PARTENAIRE_PTN       ON BI_2.PARTENAIRE_PTN.PTN_ID = BI_2.FAIT_PARTENAIRE.ACT_ID  GROUP BY  BI_2.PARTENAIRE_PTN.PTN_NOM");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/logiciels/Talend TOS_DI-20160704_1411-V6.2.1/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"projet_bi/mock_job_for_guess_schema_0_1/contexts/"
...
/************************************************************************************************
 * 32765 characters generated by Talend Open Studio for Data Integration on the
 * 1 février 2018 15:08:09 CET
 ************************************************************************************************/
