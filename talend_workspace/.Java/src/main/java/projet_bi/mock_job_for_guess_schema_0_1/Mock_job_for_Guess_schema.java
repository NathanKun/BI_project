		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.sql.ResultSet rs = stm
						.executeQuery("SELECT     BI_2.COMMERCIAL_CMC.CMC_NOM AS \"nom de commercial\",     SUM(BI_2.FAIT_COMMERCIAL.NBRE_DEMANDE) AS \"nombre de demandes acceptees\"    FROM BI_2.FAIT_COMMERCIAL    INNER JOIN BI_2.COMMERCIAL_CMC       ON BI_2.COMMERCIAL_CMC.CMC_ID = BI_2.FAIT_COMMERCIAL.UTILISATEUR_ID  GROUP BY  BI_2.COMMERCIAL_CMC.CMC_NOM  ");
...
/************************************************************************************************
 * 32575 characters generated by Talend Open Studio for Data Integration on the
 * 1 février 2018 18:55:31 CET
 ************************************************************************************************/
