...
SELECT 
  BI_2.COMMERCIAL_CMC.CMC_NOM AS \"nom de commercial\", 
  SUM(BI_2.FAIT_COMMERCIAL.MONTANT_DEMANDE) AS \"chiffre d'affaires cet an\"
  FROM BI_2.FAIT_COMMERCIAL
  INNER JOIN BI_2.COMMERCIAL_CMC 
    ON BI_2.COMMERCIAL_CMC.CMC_ID = BI_2.FAIT_COMMERCIAL.UTILISATEUR_ID
  WHERE BI_2.FAIT_COMMERCIAL.DATE_DTE_ID IN (
...
SELECT 
  BI_2.COMMERCIAL_CMC.CMC_NOM AS \"nom de commercial\", 
  SUM(BI_2.FAIT_COMMERCIAL.MONTANT_DEMANDE) AS \"chiffre d'affaire de ce mois\"
  FROM BI_2.FAIT_COMMERCIAL
  INNER JOIN BI_2.COMMERCIAL_CMC 
    ON BI_2.COMMERCIAL_CMC.CMC_ID = BI_2.FAIT_COMMERCIAL.UTILISATEUR_ID
  WHERE BI_2.FAIT_COMMERCIAL.DATE_DTE_ID IN (
...
SELECT 
  ...
  (CASE WHEN 
    ...
    > 
    AVG(BI_2.FAIT_PARTENAIRE.CAPITAL_SOCIAL) 
...
-- Nombre total de demandes
SELECT 
  BI_2.FOURNISSEUR_FNS.FNS_NOM AS \"founisseur nom\", 
  SUM(BI_2.FAIT_FOURNISSEUR.NBRE_DEMANDE) AS \"nombre de demades\"
...
SELECT 
  BI_2.FOURNISSEUR_FNS.FNS_NOM AS \"founisseur Nom\", 
  SUM(BI_2.FAIT_FOURNISSEUR.MONTANT_DEMANDE) AS \"chiffre d'affaires\"
  FROM BI_2.FAIT_FOURNISSEUR
  INNER JOIN BI_2.FOURNISSEUR_FNS 
    ON BI_2.FOURNISSEUR_FNS.FNS_ID = BI_2.FAIT_FOURNISSEUR.FOURNISSEUR_ID
GROUP BY  BI_2.FOURNISSEUR_FNS.FNS_NOM;
...
SELECT 
  BI_2.FOURNISSEUR_FNS.FNS_NOM AS \"founisseur Nom\", 
  SUM(BI_2.FAIT_FOURNISSEUR.NBRE_DEMANDE) AS \"nombre de demandes cloturées\"
  FROM BI_2.FAIT_FOURNISSEUR
  INNER JOIN BI_2.FOURNISSEUR_FNS 
    ON BI_2.FOURNISSEUR_FNS.FNS_ID = BI_2.FAIT_FOURNISSEUR.FOURNISSEUR_ID
...
SELECT 
  ...
  SUM(BI_2.FAIT_GARANT.NBRE_DEMANDE) AS \"nombre demandes\"
...
SELECT 
  BI_2.GARANT_GRT.GRT_NOM AS \"Garant Nom\", 
  SUM(BI_2.FAIT_GARANT.MONTANT_DEMANDE) AS \"chiffre daffaires\"
  FROM BI_2.FAIT_GARANT
  INNER JOIN BI_2.GARANT_GRT 
    ON BI_2.GARANT_GRT.GRT_ID = BI_2.FAIT_GARANT.GARANT_ID
GROUP BY  BI_2.GARANT_GRT.GRT_NOM;
...
SELECT 
  BI_2.GARANT_GRT.GRT_NOM AS \"garant nom\", 
  SUM(BI_2.FAIT_GARANT.NBRE_DEMANDE) AS \"nombre demandes cloturées\"
  FROM BI_2.FAIT_GARANT
  INNER JOIN BI_2.GARANT_GRT 
    ON BI_2.GARANT_GRT.GRT_ID = BI_2.FAIT_GARANT.GARANT_ID
...
SELECT 
  ...
  (CASE WHEN 
    ...
    > 
    AVG(BI_2.FAIT_GARANT.CAPITAL_SOCIAL) 
    THEN 1 ELSE 0 END) AS \"CRD>Capital Social?\",
